...
class PatrolGPSNode(Node):
    def __init__(self):
        ...
        self.sub_gps = self.create_subscription(NavSatFix, '/rbq/patrol_gps_node/sim_fix', self.gps_callback, qos_profile_sensor_data) # '/ublox_gps_node/fix'
        self.sub_gps_stat = self.create_subscription(NavPVT, '/rbq/patrol_gps_node/sim_navpvt', self.gps_stat_callback, qos_profile_sensor_data) # '/ublox_gps_node/navpvt'
