...
def generate_launch_description():
      return LaunchDescription([
          ...
          DeclareLaunchArgument('host',                  default_value='ntrip.ndgps.go.kr'), # ntrip.ndgps.go.kr
          DeclareLaunchArgument('port',                  default_value='2101'),
          DeclareLaunchArgument('mountpoint',            default_value='OKCH_RTCM30'), # ANHN_RTCM23
          DeclareLaunchArgument('ntrip_version',         default_value='None'),
          DeclareLaunchArgument('authenticate',          default_value='True'),
          DeclareLaunchArgument('username',              default_value='nmpnt'), # nmpnt
          DeclareLaunchArgument('password',              default_value='nmpnt'), # nmpnt
